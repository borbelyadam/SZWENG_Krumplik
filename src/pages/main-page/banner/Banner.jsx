...
import styledButtonL from "./styledButtonL.png";
import styledButton from "./styledButton.png";
    ...
    <>
      <div id="BannerPic" style={currentBanner[IndexCount]}>
        <button style={LeftButton} onClick={indexMinus()}>
          <img src={styledButton} alt="Bal" width={"60px"} />
        </button>

        <button style={RightButton} onClick={indexPlus()}>
          <img src={styledButtonL} alt="Jobb" width={"60px"} />
        </button>
      </div>
    </>
  );
